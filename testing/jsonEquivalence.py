#! /usr/bin/python
#
# Verify that two JSON files on disk are
# equivalent.
#
...
if len(sys.argv) < 3:
        print ""
        print "Usage : %s <json_file_one> <json_file_two>" % sys.argv[0]
        print ""
        sys.exit()

json_one_filename = sys.argv[1]
json_two_filename = sys.argv[2]

print "Comparing " + json_one_filename + " and " + json_two_filename
